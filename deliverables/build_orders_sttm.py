...
COLUMN_META = {
    ...
    "Processed At": (
        ...
        "Payment/process timestamp. Used as order_date (not Created At).",
    ),
    "Top Row": (
    ...
    derived_rows = [
        {
            ...
            "notes / business rule": "Derived in 01_load_and_merge.py. Analytical order date — not a raw export column.",
        },
        {
            "target_column": "store",
        ...
        },
        {
            ...
            "notes / business rule": "Derived product family — not a product-master join.",
        },
        {
        ...
        },
        {
            ...
            "pk_fk": "",
            "source_file(s)": "orders.parquet (derived)",
            "source_column": "Price: Total",
            "source_data_type": "decimal",
            "transformation": "SUM(Price: Total) GROUP BY customer_id.",
            "notes / business rule": "Customer LTV definition used in finals analysis.",
        },
        {
            "target_column": "is_repeat",
            "target_data_type": "BOOL",
            "pk_fk": "",
            "source_file(s)": "customers.parquet (derived)",
            "source_column": "order count (derived)",
            "source_data_type": "bool",
            "transformation": "total_orders >= 2.",
            "notes / business rule": "Repeat customer flag.",
        },
        {
            ...
            "notes / business rule": "Ever had a Shopify subscription order.",
        },
        {
            ...
            "notes / business rule": "Acquisition channel for LTV-by-channel analysis.",
        },
        {
            ...
            "notes / business rule": "Monthly acquisition cohort key.",
        },
    ]
