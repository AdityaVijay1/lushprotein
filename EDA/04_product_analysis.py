"""
04_product_analysis.py  aEUR"  Product stickiness and SKU-level analysis.
...
# a"EURa"EUR Loyalty ratio: what % of checkout SKU customers stay for recurring? a"EURa"EURa"EURa"EUR
...
#                                                                             
# E.  PRODUCT A-- CHANNEL CROSS-TAB
#                                                                             
print("\n\n[E] PRODUCT A-- CHANNEL CROSS-TAB (% of orders)")
print("=" * 60)
